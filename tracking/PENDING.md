...
- [ ] **Configuración de reservas y formulario interactivo** [Sin asignar]
  - Conectar formulario de contacto/reservas con backend / Firebase o servicio de mensajería.
- [ ] **Revisión y personalización de contenido y textos definitivos** [Sin asignar]
  - Ajustar catálogo de servicios, horarios y propuesta de valor real de Jardín de la Vida.
...
- [ ] **Panel de administración para gestión de contenidos y testimonios** [Sin asignar]
  - Diseñar panel ligero para actualizar servicios, reseñas y promociones.
